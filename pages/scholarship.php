...
<div
  ...
  <div class="container text-center my-5 py-5">
    <h1 class="text-white mt-4 mb-4">Scholarship</h1>
  </div>
</div>
<!-- Header End -->
...
<div class="container">
  <div class="card p-4 rounded shadow">
    <h3>How to apply UK University scholarships?</h3>
    <p>
    ...
    <h3>To start your search, follow the below steps:</h3>
    ...
    <h3>Award type of Wilor Education partner UK University scholarships</h3>
